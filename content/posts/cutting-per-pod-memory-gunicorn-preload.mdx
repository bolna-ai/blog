...
coverImage: "/images/posts/cutting-per-pod-memory-gunicorn-preload/cover.png"
excerpt: "We run a real-time voice service whose containers were using too much memory and restarting during calls. Two findings: the restarts were liveness-probe timeout…"
