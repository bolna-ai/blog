...
excerpt: "Bolna's Workday integration screens applicants over natural voice conversations, surfacing qualified candidates while jobs are still open."
coverImage: "/images/posts/workday-integration/cover.jpg"
coverCaption: "Applicants filling out preliminary forms at Lockheed in the 1940s, the paperwork this integration removes."
sourceUrl: "https://blog.bolna.ai/workday-integration/"
---
...
![Illustration representing challenges in manual resume screening](/images/posts/workday-integration/Bolna-feature-image-1-1-1024x576.png)

That is where Bolna helps. It acts as AI recruiting software by using voice-based AI to engage with candidates, ask important questions, and quickly deliver insights. It connects with the ATS platforms to automate early screening and help your team move faster. In this blog, you will learn how Bolna’s voice AI powers smarter hiring through seamless Workday [integration](https://www.bolna.ai/blog/bolna-plivo-integration), improving speed and accuracy at scale.
...
![Key Capabilities of Bolna with ATS Platforms ](/images/posts/workday-integration/Colorful-Pastel-Childish-Modern-Scheme-Concept-Mind-Map-Graph.png)

Key Capabilities of Bolna with ATS Platforms (Image by author)
...
![Hiring Challenges: What Talent Acquisition Leaders Encounter Today](https://blog.rpoassociation.org/hs-fs/hubfs/images/RPOAImg103.jpg?width=800&name=RPOAImg103.jpg "Hiring Challenges: What Talent Acquisition Leaders Encounter Today")

When hiring teams fall behind, everyone feels the pressure ([source](https://blog.rpoassociation.org/blog/hiring-challenges-what-talent-acquisition-leaders-encounter-today))
...
![Bolna and Workday Integration flow](/images/posts/workday-integration/Soft-Green-Simple-Marketing-Strategies-for-Small-Businesses-Graph-1.png)

Bolna and Workday Integration flow (Image by author)
...
Bolna connects to Workday using API access to ensure the Workday integration is smooth and secure  
There are two ways to set this up:

-   **Direct connection via Workday API:** Use developer credentials to fetch candidate data securely.
-   **Third-party connectors**: The [Nango platform](https://nango.dev/api-integrations) offers no-code or low-code integration options that simplify API connectivity and manage data syncing automatically.
...
![Screenshot of the Bolna dashboard for creating a voice agent](https://lh7-rt.googleusercontent.com/docsz/AD_4nXdqHnDpecDHJF8AjgPJ5jVhh0mtsW0r_MbJLMkhf7hdUxDaqGCEVYEWJVB-bBtEx8YzMc6sNhSQLVFjc89FHvSjCmHWTJGaT6PNcbd_ObWah05sHes8SA1NxvxmgRiYMzy9rkxO?key=7PBePNy5MvNE8m6VYhodFBtj)

Bolna’s dashboard ([source](https://agents.bolna.ai/))
...
![Screenshot of an AI-generated conversation summary](/images/posts/workday-integration/Screenshot-2025-05-08-at-17.01.21.png)

Conversation summary from the agent

-   A fit score based on screening criteria

![Screenshot of a candidate's fit score in Bolna](/images/posts/workday-integration/screenshot_2025-05-08_at_17.04.03-1-789x1024.png)

Candidate score

-   Notes, alerts, and action points

![Screenshot of action points generated after a candidate call](/images/posts/workday-integration/screenshot_2025-05-08_at_17.03.10-1-601x1024.png)

Action points

-   Full transcripts, if needed

![Screenshot of a full call transcript in Bolna](/images/posts/workday-integration/screenshot_2025-05-08_at_17.01.14-1-780x1024.png)

Transcript of the call

All insights are synced back into Workday using [Bolna APIs](https://www.bolna.ai/docs/api-reference/executions/get_execution) or even [webhooks](https://www.bolna.ai/docs/guides/post-call/polling-call-status-webhooks), keeping everything organized in one place. Recruiters can review, filter, and act on candidates without leaving their ATS.
