---
title: "Setting Up Pre-Call journey in Voice AI: Personalize Every Call Before It Starts"
slug: "setting-up-pre-call-journey"
date: "2025-11-19T02:39:34Z"
author: "Aakash R"
...
excerpt: "Before a call even begins, there is a small window where the experience can be shaped. This moment decides whether …"
coverImage: "/images/posts/setting-up-pre-call-journey/cover.jpg"
coverCaption: "The Bell long-distance network in 1940. The route was worked out before the call was ever placed."
sourceUrl: "https://blog.bolna.ai/setting-up-pre-call-journey/"
---
...
![Illustration representing a personalized pre-call voice AI journey](/images/posts/setting-up-pre-call-journey/Bolna-feature-image-12-1024x576.jpg)
...
![Diagram of Bolna's pre-call personalization data flow](/images/posts/setting-up-pre-call-journey/Untitled-diagram-2025-11-19-023701-1024x340.png)
...
For example, if your CRM indicates the customer is _Ravi Kumar_, and his March payment is pending, your AI might begin with:
...
![Screenshot of a voice AI prompt with variables filled in](/images/posts/setting-up-pre-call-journey/ChatGPT-Image-Nov-19-2025-08_03_05-AM-1024x683.png)
...
Each object represents an individual call. Bolna reads the keys as variable names and injects them directly into your script, ensuring the _ivr automation setup_ stays consistent across large volumes of outbound calls.
...
> “Hi {name}, I noticed your {plan} plan is coming up for renewal on {expiry\_date}. Would you like help renewing it right now?”
